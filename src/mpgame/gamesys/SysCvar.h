...
extern idCVar	g_presentationInterpolation;
...
extern idCVar	si_freezeThawThroughSurface;
extern idCVar	si_freezeAutoThawTime;
extern idCVar	si_freezeWorldDeathDelay;

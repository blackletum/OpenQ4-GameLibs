...
idCVar bot_pathdebug( "bot_pathdebug", "0", CVAR_GAME | CVAR_BOOL | CVAR_CHEAT, "force the bot to path to player" );
...
idCVar bot_showstate( "bot_showstate", "0", CVAR_GAME | CVAR_BOOL | CVAR_CHEAT, "draws the bot state above the bot" );

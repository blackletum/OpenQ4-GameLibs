...
idCVar g_corpseRemoveDelaySP(		"g_corpseRemoveDelaySP",	"0",			CVAR_GAME | PC_CVAR_ARCHIVE | CVAR_FLOAT, "seconds before single-player corpses begin disappearing (0 = stock timing, -1 = never)", -1, 3600 );
